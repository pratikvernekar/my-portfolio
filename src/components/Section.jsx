      ...
      <div className="section-content">  
        <div className="text">
          ...
          <p className="description">
            I'm Pratik Vernekar, a frontend developer skilled in React and React
            Native. Focused on crafting clean & user-friendly experiences.
          </p>
        </div>
        ...
        <div className="social-links">
          <ul className="example-2">
            <li className="icon-content">
              <a target="_blank" href="https://www.linkedin.com/in/pratik-vernekar-7b036a170/" aria-label="LinkedIn" data-social="linkedin">
            ...
            <li className="icon-content">
              <a target="_blank" href="https://github.com/pratikvernekar" aria-label="GitHub" data-social="github">
                <div className="filled"></div>
        ...
        <div className="image-container">
          <img src={profilePic} alt="Profile" className={`profile-image ${darkMode ? "darkBorder" : "lightBorder"}`} />
        </div>
      </div>
    </section>
  );
